...
public class FlipLoadingLayout extends LoadingLayout {
	...
	private final Animation mRotateAnimation, mResetRotateAnimation, mRefreshingRotateAnimation;
	...
	public FlipLoadingLayout(Context context, final Mode mode, final Orientation scrollDirection, TypedArray attrs) {
		...
		mRefreshingRotateAnimation = new RotateAnimation(0, 720, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
        mRefreshingRotateAnimation.setInterpolator(ANIMATION_INTERPOLATOR);
        mRefreshingRotateAnimation.setDuration(ROTATION_ANIMATION_DURATION);
	...
	protected void refreshingImpl() {
		...
		mHeaderProgressImage.startAnimation(mRefreshingRotateAnimation);
	}
